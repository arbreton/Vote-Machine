...
var app = angular.module('adminParty', ['ngFileUpload', 'serviceMatch']);

app.controller('registerPartyController', [ '$scope', '$http', 'Upload', '$timeout', 'match', function($scope, $http, Upload, $timeout, match)
{
  var that = $scope;
  that.candidate = {};
